...
class MeetingNet_Transformer_ernie_cpu(nn.Module):
    def __init__(self, opt):
        super(MeetingNet_Transformer_ernie_cpu, self).__init__()
    ...
    def _forward(self, **kwargs):
        ...
        token_encoder_outputs, sent_encoder_outputs, topic_segment_output, role_ae_loss = self.encoder(encoder_input_ids, encoder_input_roles, encoder_input_pos, encoder_input_ent)
    ...
    def generate(self, batch, max_sent_len):
        ...
        outputs = self._generate(
            ...
            temperature=self.opt.get("TEMPERATURE", 1),
    ...
    def _generate_beam_search(
        ...
        for batch_idx in range(batch_size):
            ...
            print('generated_hyps:', generated_hyps)
