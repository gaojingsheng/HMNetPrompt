...
class MeetingNet_Transformer_ernie_topicseg_inputmask_cpu(nn.Module):
    def __init__(self, opt):
        super(MeetingNet_Transformer_ernie_topicseg_inputmask_cpu, self).__init__()
    ...
    def _generate_no_beam_search(
        ...
        while cur_len < max_length:
            ...
            outputs = self.decoder(**model_inputs)[0]
    ...
    def _generate_beam_search(
        ...
        while cur_len < max_length:
            model_inputs = self.prepare_inputs_for_generation(input_ids, past=past, attention_mask=attention_mask)
            outputs = self.decoder(**model_inputs)[0]  # (batch_size * num_beams, cur_len, vocab_size)
