...
class HMNetTrainer_pretrain(DistributedTrainer):
    '''
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch_idx, numEpochs):
            ...
            for batch_idx, batch in enumerate(self.train_batch_generator):
                ...
                if ('SAVE_PER_UPDATE_NUM' in self.opt) and (self.updates + 1) % self.opt['SAVE_PER_UPDATE_NUM'] == 0 and self.updates >=50000:
